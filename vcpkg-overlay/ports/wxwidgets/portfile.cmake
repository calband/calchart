...
# Only set wxUSE_WEBVIEW_EDGE on Windows with webview feature
# On other platforms, wxWidgets uses native WebKit (macOS) or GTK WebKit (Linux)
if("webview" IN_LIST FEATURES AND VCPKG_TARGET_IS_WINDOWS)
    list(APPEND FEATURE_OPTIONS "-DwxUSE_WEBVIEW_EDGE=ON")
endif()

# Only set wxUSE_WEBVIEW_EDGE_STATIC on Windows with webview feature and static linkage
if("webview" IN_LIST FEATURES AND VCPKG_LIBRARY_LINKAGE STREQUAL "static" AND VCPKG_TARGET_IS_WINDOWS)

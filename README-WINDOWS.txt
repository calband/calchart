...
Go to wxwidgets.org and download the exe installer (which will put the source at c:\wxWidgets-3.0.0

Make wxWidgets:
(I'm following the instructions at wiki.wxWidgets.org/Install)
Open Visual C++ Express 2013 for Windows Desktop.
Open the project wx_vc10.sln at wxWidgets-3.0.0\build\msw.  It should prompt you to migrate the project.

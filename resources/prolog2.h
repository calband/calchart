...
static char prolog2_ps[] = "/smoveto { transform round exch round exch itransform moveto } def\n"
                           ...
                           "      dup .2 sub fieldw mul 20 div 84 ehash sub fieldh mul 84 div "
                           "smoveto\n"
                           "      dup .2 add fieldw mul 20 div 84 ehash sub fieldh mul 84 div slineto "
                           "stroke\n"
                           "      dup .2 sub fieldw mul 20 div 84 whash sub fieldh mul 84 div "
                           "smoveto\n"
                           "      .2 add fieldw mul 20 div 84 whash sub fieldh mul 84 div slineto "
                           "stroke\n"
                           "   } for\n"
                           "} bind def\n";
#endif // _PROLOG2_H_

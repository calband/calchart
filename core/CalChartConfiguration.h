...
private:                                           \
    ...
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_X_4, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_Y_4, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_Z_4, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewAngle_4, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewAngle_Z_4, double);

    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_X_5, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_Y_5, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_Z_5, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewAngle_5, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewAngle_Z_5, double);

    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_X_6, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_Y_6, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewPoint_Z_6, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewAngle_6, double);
    DECLARE_CONFIGURATION_FUNCTIONS(OmniViewAngle_Z_6, double);

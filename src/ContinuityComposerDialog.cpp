...
const std::pair<std::string, std::function<std::unique_ptr<CalChart::Cont::Value>()>> ValueMap[] = {
    ...
    { "North", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_N); } },
    { "NorthEast", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_NE); } },
    { "East", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_E); } },
    { "SouthEast", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_SE); } },
    { "South", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_S); } },
    { "SouthWest", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_SW); } },
    { "West", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_W); } },
    { "NorthWest", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_NW); } },
    { "HighStep", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_HS); } },
    { "Mini-Military", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_MM); } },
    { "ShowHigh", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_SH); } },
    { "Jerky Step", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_JS); } },
    { "GrapeVine", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_GV); } },
    { "Military", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_M); } },
    { "Diagonal Military", []() { return std::make_unique<CalChart::Cont::ValueDefined>(CalChart::Cont::DefinedValue::CC_DM); } },
};

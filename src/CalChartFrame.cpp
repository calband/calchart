    ...
    , mAUIManager(new wxAuiManager(this))
{
    ...
    CreateStatusBar(3);
    SetStatusText("Welcome to Calchart v" STRINGIZE(CC_MAJOR_VERSION) "." STRINGIZE(CC_MINOR_VERSION) "." STRINGIZE(CC_SUB_MINOR_VERSION));
...
void CalChartFrame::OnCmdAbout(wxCommandEvent& event) { CalChartSplash::About(); }

void CalChartFrame::OnCmdHelp(wxCommandEvent& event) { CalChartSplash::Help(); }

...
auto clipPointsToView(CalChartView const& view, CalChart::MovePointsTool const& tool, std::map<int, CalChart::Coord> points, std::function<CalChart::Coord(CalChart::Coord c)> snapper)
{
    auto result = std::map<int, CalChart::Coord>{};

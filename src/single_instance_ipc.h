...
// The HostAppInterface will determine if the App is a server, client or independent app.
// Hand it the functions to call if it's a server or client; it determines which to call.

...
inline auto toCenterText(std::string text) -> DrawCommand
{
    return Text{ {}, std::move(text), Text::TextAnchor::HorizontalCenter | Text::TextAnchor::Top };
}

}

namespace CalChart::Draw::Field {
...
namespace CalChart::Draw::details {

...
Coord Sheet::GetMarcherPosition(unsigned i, unsigned ref) const
{
    return GetMarcher(i).GetPos(ref);
}
...
auto Sheet::GetAllMarchers() const -> std::vector<Point> { return mPoints; }
